  ...
  return (
    <div className="absolute h-full w-full overflow-hidden">
      ...
      >
        ...
        <div className="absolute top-2 md:top-4 w-60 md:w-80 h-60 md:h-80 bg-slate-400 rounded-full opacity-70" />
        <div className="absolute top-4 md:top-8 w-60 md:w-80 h-60 md:h-80 bg-slate-500 rounded-full opacity-50" />
      </div>
    </div>
  );
}
